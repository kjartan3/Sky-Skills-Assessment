...
const AssessmentPDF = ({ assessmentId, stats, assessment, getContentForBehaviour }) => (
  <Document>
    <Page style={styles.page}>
      ...
      <Text style={styles.paragraph}>
        We’ve got you covered – this summary breaks down the results of your self-assessment and reveals your top 3 behavioural strengths, pinpoints areas to grow, dives deeper into your skillset and delivers personalised learning recommendations from the Sky Skills channel on Sky Learn.
      </Text>
